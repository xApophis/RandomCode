...
public class TestGestionAttaque {
	public static void main(String[] args) {
		Monstre<Feu> dragotenebre = new Monstre<>("dragotenebre", 200, 
				ZoneDeCombat.AERIEN, Domaine.FEU, new BouleDeFeu(1));
...
//		RESULTAT ATTENDU
//		Monstre [getNom()=dragotenebre, attaques=[ForceDeCombat
//		[nom=une boule de feu, pointDeDegat=20], ForceDeCombat [nom=un jet de lave,
//		pointDeDegat=80], ForceDeCombat [nom=un éclair, pointDeDegat=50]],
//		zoneDeCombat=AERIEN, getForceDeVie()=200]
